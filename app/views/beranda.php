    ...
    <section id="home" class="portfolio">
      ...
      <div class="container" data-aos="fade-up">
        ...
        <header class="section-header">
          <h1>Menyediakan source code aplikasi secara GRATIS <b> !!!</b> </h1>
          <p></p>
        </header>
        ...
        <div class="row" data-aos="fade-up" data-aos-delay="100">
          <div class="col-lg-12 d-flex justify-content-center">
            <ul id="portfolio-flters">
              ...
              <li data-filter=".filter-card">Android Development</li>
              <li data-filter=".filter-web">Digital Printing</li>
            </ul>
          </div>
        </div>
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-6 col-md-6" data-aos="fade-up" data-aos-delay="200">
            <div class="service-box blue">
              ...
              <h3>Web Design</h3>
              <p> istilah mengenai desaign visual yang diterapkan kepada media digital yaitu website, design yang ditunjukan untuk pengembangan dan styling informasi di internet untuk menyediakan fitur konsumen high-end dan memberikan kualitas estetika.</p>
          ...
          <div class="col-lg-6 col-md-6" data-aos="fade-up" data-aos-delay="300">
            <div class="service-box orange">
              ...
              <p>Membuat program dan aplikasi berbasis website. Contoh aplikasi berbasis web E-Learnin, E-Banking, E-Commerce, Sistem Layanan Mahasiswa, Booking Online, Enterprise Resource Planning, dan Transaction Processing System.</p>
              <a href="#" class="read-more"><span>Read More</span> <i class="bi bi-arrow-right"></i></a>
            </div>
          </div>
          ...
          <div class="col-lg-6 col-md-6" data-aos="fade-up" data-aos-delay="400">
            <div class="service-box green">
              ...
              <p>orang yang bertanggung jawab untuk mengembangkan dan membangun perangkat lunak berbasis mobile menggunakan sistem operasi Android. </p>
              <a href="#" class="read-more"><span>Read More</span> <i class="bi bi-arrow-right"></i></a>
            </div>
          </div>
          ...
          <div class="col-lg-6 col-md-6" data-aos="fade-up" data-aos-delay="500">
            <div class="service-box red">
              ...
              <p>metode percetakan dari gambar berbasis digital, yang biasanya berupa berkas, kemudian bisa langsung dicetak di berbagai media dengan secara instan dan cepat. Contoh Pembuatan Banner/spanduk dan Stiker </p>
              <a href="#" class="read-more"><span>Read More</span> <i class="bi bi-arrow-right"></i></a>
            </div>
          </div>
            ...
            <div class="row gy-4">
              <div class="col-md-6">
                <div class="info-box">
                  ...
                  <h3>Address</h3>
                  <p>Jalan Imogiri Barat Km. 5 <br> Tanjung Bangunharjo Sewon Bantul </p>
                </div>
              </div>
              <div class="col-md-6">
                <div class="info-box">
            ...
            <br>
              ...
              <div class="col-md-6">
                <div class="info-box">
                  ...
                  <h3>Email Us</h3>
                  <p>sediakoding.com<br>sediakoding@gmail.com</p>
                </div>
              </div>
              <div class="col-md-6">
                <div class="info-box">
